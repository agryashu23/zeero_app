...
class HeartBeatAppBar extends StatelessWidget {
  ...
  HeartBeatAppBar({required this.from, required this.to});
...
class HeartBeatAppBarContent extends StatefulWidget {
  ...
  HeartBeatAppBarContent(this.device, {required this.from, required this.to});
          ...
          builder: (BuildContext context, child) {
            return Row(
              ...
              children: <Widget>[
                GestureDetector(
                  onTapUp: (details) {
                    navigateToScreen(context, from: 1, to: 4, nextPageBody: HeartBeatPage.defaultPages[1]);
                  },
                  child: Container(
