...
class ShowLeadSearch extends StatefulWidget {
  static String routeName = "/show_lead_search";

  const ShowLeadSearch({Key? key}) : super(key: key);

  @override
  State<ShowLeadSearch> createState() => _ShowLeadSearchState();
}

class _ShowLeadSearchState extends State<ShowLeadSearch> {
  List id=[];
